...
export function WelcomeStep({ onNext }: WelcomeStepProps) {
  ...
  return (
    <div className='space-y-8'>
      {/* Hero Section */}
      <Card className='glass-card luxury-shadow-light relative overflow-hidden border-0'>
        ...
        <CardContent className='relative z-10 p-12 text-center'>
          ...
          <div className='mb-8 flex flex-wrap justify-center gap-4'>
            ...
            <Badge className='border-0 bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-lg text-white'>
              <Zap className='mr-2 h-4 w-4' />
              Step-by-Step Guide
            </Badge>
            <Badge className='border-0 bg-gradient-to-r from-amber-500 to-orange-500 px-4 py-2 text-lg text-white'>
          ...
          <Button
            onClick={onNext}
            size='lg'
            className='soft-shadow border-0 bg-gradient-to-r from-purple-500 to-blue-500 px-8 py-4 text-lg text-white transition-all duration-300 hover:scale-105'
          >
            Start Your Journey
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        {features.map((feature, index) => (
          <Card
            key={index}
            className='glass-card luxury-shadow-light border-0 transition-all duration-300 hover:scale-105'
          >
      ...
      {/* Stats Section */}
      <Card className='glass-card luxury-shadow-light border-0'>
        <CardContent className='p-8'>
      ...
      <Card className='glass-card luxury-shadow-light border-0'>
        <CardContent className='p-8 text-center'>
          ...
          <p className='mb-6 text-lg text-gray-600'>
            ...
            to know about Cosmos staking, from wallet setup to validator
