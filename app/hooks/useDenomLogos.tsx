      ...
      try {
        ...
        await Promise.all(
          chains.map(async (chain) => {
            try {
              const response = await fetch(`${CHAIN_REGISTRY_BASE}/${chain}/assetlist.json`);
              ...
              assetList.assets?.forEach((asset: Asset) => {
                ...
                if (logoUrl) {
                  ...
                  if (asset.symbol) {
                    ...
                    console.log(`Added logo for ${asset.symbol.toLowerCase()}: ${logoUrl}`);
                  }
                } else {
        ...
        const hardcodedLogos: Record<string, string> = {
          ...
          'ujuno': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/juno/images/juno.png',
          'juno': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/juno/images/juno.png',
          'ustars': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/stargaze/images/stars.png',
          ...
          'aevmos': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/evmos/images/evmos.png',
          'evmos': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/evmos/images/evmos.png',
          'ustrd': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/stride/images/strd.png',
          'strd': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/stride/images/strd.png',
          'uxprt': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/persistence/images/xprt.png',
          'xprt': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/persistence/images/xprt.png',
          'uregen': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/regen/images/regen.png',
          'regen': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/regen/images/regen.png',
          'uhuahua': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/chihuahua/images/huahua.png',
          'huahua': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/chihuahua/images/huahua.png',
        };
        ...
        const chainLogos: Record<string, string> = {
          ...
          'axelar': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/axelar/images/axl.png',
          'evmos': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/evmos/images/evmos.png',
          'crescent': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/crescent/images/cre.png',
          'comdex': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/comdex/images/cmdx.png',
          'chihuahua': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/chihuahua/images/huahua.png',
          'stride': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/stride/images/strd.png',
          'quicksilver': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/quicksilver/images/qck.png',
          'kujira': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/kujira/images/kuji.png',
          'persistence': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/persistence/images/xprt.png',
          'regen': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/regen/images/regen.png',
          'bitsong': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/bitsong/images/btsg.png',
          'gravitybridge': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/gravitybridge/images/grav.png',
          'umee': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/umee/images/umee.png',
          'desmos': 'https://raw.githubusercontent.com/cosmos/chain-registry/master/desmos/images/dsm.png',
        };
